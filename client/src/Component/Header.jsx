    ...
    return (
        <div>
            <Navbar bg="dark" variant="dark">
                <Container>
                    <Navbar.Brand href="#home">Maple InFo</Navbar.Brand>
                    ...
                    <Navbar.Collapse className="justify-content-end">
                        <Navbar.Text>
                            <a href="/client/src/component/Signin" style={{ textDecoration: 'none', marginRight: '10px' }}>로그인</a>
                        </Navbar.Text>
                        <Navbar.Text>
                            <a href="/client/src/component/Signup" style={{ textDecoration: 'none' }}>회원가입</a>
                        </Navbar.Text>
                    </Navbar.Collapse>
                </Container>
            </Navbar>
